...
(function(window, $, undefined) {
    ...
    (function() {
        var VERSION = '2.2.0',
            ...
            $body, $datepickersContainer, containerBuilt = false,
            baseTemplate = '' +
        ...
        datepicker.prototype = {
            ...
            setPosition: function(position) {
                ...
                var dims = this._getDimensions(this.$el),
                    ...
                    pos = position.split(' '),
                    top, left, offset = this.opts.offset,
                    main = pos[0],
                    secondary = pos[1];
                switch (main) {
                    case 'top':
            ...
            _handleHotKey: function(key) {
                var date = datepicker.getParsedDate(this._getFocusedDate()),
                    focusedParsed, o = this.opts,
                    newDate, totalDaysInNextMonth, monthChanged = false,
                    yearChanged = false,
                    decadeChanged = false,
                    y = date.year,
                    m = date.month,
